...
## ค้นหาฟังก์ชันและการตั้งค่า

คลิกปุ่มค้นหาบนแถบด้านบน เลือก **การตั้งค่า → ค้นหาฟังก์ชัน** หรือกด `Ctrl+K` (`Command+K` บน macOS) ค้นหาแบบออฟไลน์ด้วยชื่อฟังก์ชันในภาษาใดก็ได้ที่รองรับ หากช่องค้นหาว่าง ให้กดลูกศรลงหรือเลือก **ดูฟังก์ชันทั้งหมด** เพื่อดูรายการทั้งหมดแยกตามหมวดหมู่ ใช้ปุ่มลูกศรเลือกรายการ หลังยืนยันตัวเลือกจาก IME แล้ว ต้องกด `Enter` อีกครั้งเป็นการกระทำแยกต่างหากจึงจะเปิดรายการนั้น ผลลัพธ์ประเภทเมนูและกล่องโต้ตอบจะเปิดจุดเข้าถึงเดิม ส่วนผลลัพธ์ประเภทการตั้งค่าจะเพียงเลื่อนไปและโฟกัสตัวควบคุมโดยไม่เปลี่ยนค่าอัตโนมัติ รายการที่ยังใช้ไม่ได้จะแสดงเหตุผล และ `Esc` จะปิดการค้นหาแล้วคืนโฟกัสเดิม
