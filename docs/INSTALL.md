...
- KataGo 版本输出：`v1.18.2`，项目从官方已合并提交 `47aadc08518b3e121f22539796c911002f699584` 自编译；不是官方发布二进制。完整包包含同树选点评估能力，小更新包不含引擎
- 默认权重：官方旗舰 B11 Transformer `kata1-tf3-b11c768-s11750M-d6216M.bin.gz`（界面显示“Transformer B11 · 2026-09-12”，`211,575,408` 字节，约 202 MiB）
